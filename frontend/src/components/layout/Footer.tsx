    ...
    <footer className="mt-auto bg-white border-t border-gray-100">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-3 tracking-tight">ToiToi</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link to="/repair" className="hover:text-primary-600">
                  수리서비스
                </Link>
              </li>
              <li>
                <Link to="/price" className="hover:text-primary-600">
                  가격확인
                </Link>
              </li>
            </ul>
